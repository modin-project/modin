...
class MapReduceFunction(Function):
    ...
    def call(cls, map_function, reduce_function, **call_kwds):
        def caller(query_compiler, *args, **kwargs):
            ...
            if kwargs.get("numeric_only", "is_not_exist") == "is_not_exist":
                kwargs_for_reduce = kwargs
            else:
                kwargs_for_reduce = kwargs.copy()
                if kwargs_for_reduce["numeric_only"]:
                    kwargs_for_reduce["numeric_only"] = not kwargs_for_reduce[
                        "numeric_only"
                    ]
            ...
            return query_compiler.__constructor__(
                query_compiler._modin_frame._map_reduce(
                    ...
                    lambda y: reduce_function(y, *args, **kwargs_for_reduce),
