...
#  Dependency:
#      _generate_block takes in argument generated by repartition_coord_df
#      _generate_block calls extract_block
#  extract_block was moved to the end of the file


def _repartition_coord_df(old_coord_df, npartition):
    """Repartition the (view of) coord_df by npartition

    This function is used when old_coord_df is not contigous.
    ...
    chunksize = (len(old_coord_df) // npartition) + 1
