...
def read_csv(
    ...
    |                         |                 |                | Non-lazy       | if `names` is       |
    |                         |                 |                |                | defined, `header`   |
    |                         |                 |                |                | can be only 0, None |
    |                         |                 |                |                | or "infer"          |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | names                   | -               | -              | Partial        | **OmniSci**:        |
    |                         |                 |                | Non-lazy       | parameter is        |
    |                         |                 |                |                | unsupported if      |
    |                         |                 |                |                | the number of       |
    |                         |                 |                |                | provided names      |
    |                         |                 |                |                | doesn't correpond   |
    ...
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | mangle_dupe_cols        | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | converters              | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | skipinitialspace        | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    ...
    |                         |                 |                | Non-lazy       | Only True value     |
    |                         |                 |                |                | is supported        |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | parse_dates             | -               | -              | Partial        | **OmniSci**:        |
    |                         |                 |                | Non-lazy       | bool and flattened  |
    |                         |                 |                |                | list of string      |
    |                         |                 |                |                | column names are    |
    |                         |                 |                |                | supported           |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | infer_datetime_format   | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | keep_date_col           | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | date_parser             | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    ...
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | encoding_errors         | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | dialect                 | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | error_bad_lines         | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | warn_bad_lines          | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | on_bad_lines            | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | skipfooter              | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    ...
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | float_precision         | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | storage_options         | -               | -              | Harmful        |                     |
    |                         |                 |                | Non-lazy       |                     |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    """
...
def read_table(
    ...
    | Parameters              | PandasOnRay     | PandasOnDask   | OmniSci        | Notes               |
    +=========================+=================+================+================+=====================+
    | All parameters          | Partial         | Partial        | Harmful        | OmniSci execution   |
    |                         |                 |                | Non-lazy       | is not supported    |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | filepath_or_buffer      | -               | -              | Harmful        | **Ray/Dask**:       |
    |                         |                 |                | Non-lazy       | Some buffer formats |
    |                         |                 |                |                | can be unsupported  |
    +-------------------------+-----------------+----------------+----------------+---------------------+
    | skiprows                | Partial         | Partial        | Partial        | **Ray/Dask**:       |
...
def read_pickle(
    ...
    |                 |                 |                |                | Experimental implementation:     |                 |                 |                |                |  engine:                  |
