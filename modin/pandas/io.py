...
from modin.logging import LoggerMixin, logger_decorator
...
class HDFStore(LoggerMixin, pandas.HDFStore):  # noqa: PR01, D200
    """
...
class ExcelFile(LoggerMixin, pandas.ExcelFile):  # noqa: PR01, D200
    """
