...
def test_sparse_accessor_api_equality(klass):
    modin_dir = [obj for obj in dir(getattr(pd, klass).sparse) if obj[0] != "_"]
    pandas_dir = [obj for obj in dir(getattr(pandas, klass).sparse) if obj[0] != "_"]
