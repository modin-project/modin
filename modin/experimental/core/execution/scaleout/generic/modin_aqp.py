...
"""The module for working with displaying progress bars for Scaleout engine."""
...
def call_progress_bar(result_parts, line_no):
    ...
    Parameters
    ----------
    result_parts : list of list of scaleout.ObjectRef
    ...
    for i in range(1, len(futures) + 1):
        scaleout.wait(futures, num_returns=i)
