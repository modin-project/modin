...
``PyarrowOnScaleoutFrame`` is a dataframe class with PyArrow storage format and Scaleout engine.
"""

import pandas
from pandas.core.dtypes.cast import find_common_type

from ..partitioning.partition_manager import PyarrowOnScaleoutFramePartitionManager
...
class PyarrowOnScaleoutFrame(PandasFrame):
    """
    Class for dataframes with PyArrow storage format and Scaleout engine.
