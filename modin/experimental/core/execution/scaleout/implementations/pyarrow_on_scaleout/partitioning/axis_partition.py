...
"""The module defines interface for an axis partition with PyArrow storage format and Scaleout engine."""
...
class PyarrowOnScaleoutFrameAxisPartition(BaseFrameAxisPartition):
    """
    Class defines axis partition interface with PyArrow storage format and Scaleout engine.
...
class PyarrowOnScaleoutFrameColumnPartition(PyarrowOnScaleoutFrameAxisPartition):
    """
    The column partition implementation for PyArrow storage format and Scaleout engine.
...
class PyarrowOnScaleoutFrameRowPartition(PyarrowOnScaleoutFrameAxisPartition):
    """
    The row partition implementation for PyArrow storage format and Scaleout engine.
