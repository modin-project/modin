...
"""Module houses class for tracking partitions with PyArrow storage format and Scaleout engine."""

from modin.experimental.core.execution.scaleout.generic.partitioning.partition_manager import (
...
class PyarrowOnScaleoutFramePartitionManager(GenericScaleoutFramePartitionManager):
    """
    Class for tracking partitions with PyArrow storage format and Scaleout engine.
