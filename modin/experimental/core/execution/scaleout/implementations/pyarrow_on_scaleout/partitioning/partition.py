...
"""The module defines interface for a partition with PyArrow storage format and Scaleout engine."""
...
class PyarrowOnScaleoutFramePartition(PandasOnScaleoutFramePartition):
    """
    Class provides partition interface specific for PyArrow storage format and Scaleout engine.
