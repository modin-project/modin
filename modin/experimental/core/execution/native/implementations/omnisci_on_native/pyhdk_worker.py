...
"""Module provides ``PyHdkWorker`` class."""
...
class PyHdkWorker(BaseDbWorker):
    """PyHDK based wrapper class for OmniSci storage format."""
    ...
    def executeDML(cls, query):
        ra = cls._calcite.process(query, db_name="omnisci")
