...
class PandasOnUnidistDataframeAxisPartition(PandasDataframeAxisPartition):
    """
    ...
    def __init__(self, list_of_blocks, get_ip=False):
        ...
        # Unwrap unidist.ObjectRef from `PandasOnUnidistDataframePartition` object for ease of use
...
class PandasOnUnidistDataframeColumnPartition(PandasOnUnidistDataframeAxisPartition):
    """
...
class PandasOnUnidistDataframeRowPartition(PandasOnUnidistDataframeAxisPartition):
    """
