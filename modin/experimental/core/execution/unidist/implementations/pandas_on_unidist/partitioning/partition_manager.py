...
from modin.experimental.core.execution.unidist.generic.modin_aqp import (
    call_progress_bar,
)
...
class PandasOnUnidistDataframePartitionManager(GenericUnidistDataframePartitionManager):
    ...
    def map_partitions(cls, partitions, map_func):
        ...
        """
        return super(PandasOnUnidistDataframePartitionManager, cls).map_partitions(
            partitions, map_func
        )
    ...
    def lazy_map_partitions(cls, partitions, map_func):
        ...
        np.ndarray
            A NumPy array of partitions.
        """
        return super(PandasOnUnidistDataframePartitionManager, cls).lazy_map_partitions(
            partitions, map_func
        )
    ...
    def map_axis_partitions(
        ...
        **kwargs : dict
        ...
        """
        return super(PandasOnUnidistDataframePartitionManager, cls).map_axis_partitions(
            axis,
            partitions,
            map_func,
            keep_partitioning,
    ...
    def _apply_func_to_list_of_partitions(cls, func, partitions, **kwargs):
        ...
        **kwargs : dict
        ...
        -------
        list
            A list of ``PandasOnUnidistDataframePartition`` objects.
        ...
        """
        return super(
            PandasOnUnidistDataframePartitionManager, cls
    ...
    def binary_operation(cls, axis, left, func, right):
        ...
        """
        return super(PandasOnUnidistDataframePartitionManager, cls).binary_operation(
