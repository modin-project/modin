...
class BaseDataframePartition(ABC):  # pragma: no cover
    ...
    def get(self):
        ...
        E.g. if you assign `x = BaseDataframePartition.put(1)`, `x.get()` should
        always return 1.
        """
        pass
    ...
    def add_to_apply_calls(self, func, *args, **kwargs):
        ...
        **kwargs : dict
        ...
        -------
        BaseDataframePartition
            New `BaseDataframePartition` object with the function added to the call queue.
    ...
    def preprocess_func(cls, func):
        ...
        deploy a preprocessed function to multiple `BaseDataframePartition`
        objects.
        """
        pass
