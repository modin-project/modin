...
import math
from typing import Collection, Iterable, List, Optional, Set, Tuple, Union
...
class PandasOnRayDataframeVirtualPartition(BaseDataframeAxisPartition):
    ...
    def find_non_split_block(
        ...
        If all the partitions are the sequential chunks of the same DataFrame,
        the concatenation of all these chunks will give an identical DF. Thus, we
    ...
    def _calculate_lengths(self, materialize=True):  # noqa: GL08
    ...
    @property
    def _chunk_lengths(self):  # noqa: GL08
        if (
    ...
    def _apply(self, apply_fn, args, kwargs) -> DeferredExecution:  # noqa: GL08
