...
class BasePandasFrame(object):
    ...
    def astype(self, col_dtypes):
        ...
        new_frame = self._frame_mgr_cls.lazy_map_partitions(
            self._partitions, astype_builder, name="astype"
        )
        return self.__constructor__(
            new_frame,
            self.index,
    ...
    def _map_reduce(
        ...
        map_parts = self._frame_mgr_cls.lazy_map_partitions(
            self._partitions, map_func, name=map_name
        )
    ...
    def _map(
        self, func, name=None, dtypes=None, validate_index=False, validate_columns=False
    ):
