...
In this toy example, we look at the NYC taxi dataset, which is around 1.8GB in size. You can download `this dataset <https://s3.amazonaws.com/dask-data/nyc-taxi/2015/yellow_tripdata_2015-01.csv>`_ to run the example locally.

.. code-block:: python

  # This may take a few minutes to download
  import urllib.request
  s3_path = "https://s3.amazonaws.com/dask-data/nyc-taxi/2015/yellow_tripdata_2015-01.csv"
