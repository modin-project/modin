...
:py:class:`~modin.core.execution.ray.implementations.cudf_on_ray.cuDFOnRayDataframePartitionManager`.

Public API
----------

.. autoclass:: modin.core.execution.ray.implementations.cudf_on_ray.cuDFOnRayDataframe
  :members:
