...
the :py:class:`~modin.core.execution.ray.implementations.pandas_on_ray.dataframe.dataframe.PandasOnRayDataframe` which inherits
...
via the :meth:`~modin.core.execution.ray.common.task_wrapper.RayWrapper.deploy` method of :py:class:`~modin.core.execution.ray.common.task_wrapper.RayWrapper`.
