Base Modin Dataframe Interface
==============================

* :doc:`BaseDataframeAxisPartition <partitioning/axis_partition>` is an interface for a Dataframe object, representing a joined group of partitions along some axis (either rows or labels).
