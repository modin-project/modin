...
When you are working with a Core Modin Dataframe, you can unwrap its remote partitions
...
-----------------------------
By default, a Core Modin Dataframe stores underlying partitions as ``pandas.DataFrame`` objects.
