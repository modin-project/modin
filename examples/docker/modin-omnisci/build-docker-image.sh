...
\tdocker run --rm -v /path/to/dataset:/dataset python nyc-taxi-omnisci.py <name of file starting with /dataset>
...
To run the benchmark execute:
\tdocker run --rm -v /path/to/dataset:/dataset python plasticc-omnisci.py <training set file name starting with /dataset> <test set file name starting with /dataset> <training set metadata file name starting with /dataset> <test set metadata file name starting with /dataset>\n'
