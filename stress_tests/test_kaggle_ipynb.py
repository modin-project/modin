...
def generate_dataset():
    ...
    def _dataset_builder(filename, columns, dtypes, size=DF_SIZE):
    ...
    # Delete csv files created
    subprocess.Popen("rm *.csv")
...
def test_kaggle3(generate_dataset):
    ...
    ipynb = subprocess.Popen(["python", "{}/{}".format(DIR_PATH, "kaggle/kaggle3.py")], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
